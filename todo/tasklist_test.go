...
func TestTaskList_WriteFile(t *testing.T) {
	...
	//nolint:gosec // pathFileOutput is a temporary file path generated by testGetPathFileTemp, safe for testing
	...
	require.NoError(t, fileOutput.Close(), "failed to close file")
