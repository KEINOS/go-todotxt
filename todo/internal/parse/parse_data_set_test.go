...
var dataValidVarious = []struct {
	...
	// Full and empty components
	{
		...
		expected: Components{
			...
			KeyValues:        []KeyValue{{Key: "due", Value: "2016-05-30"}, {Key: "location", Value: "mainOffice"}},
	...
	},
	{
		...
		expected: Components{
			...
			KeyValues:        []KeyValue{{Key: "location", Value: "AWS"}, {Key: "due", Value: "2025-10-15"}},
			Comment:          "",
		},
	},
	{
	...
	},
	{
		...
		expected: Components{
			...
			KeyValues:        []KeyValue{{Key: "location", Value: "AWS"}, {Key: "due", Value: "2016-05-25"}},
			Comment:          "",
		},
	},
	// Test #10
	...
	},
	{
		...
		expected: Components{
			...
			KeyValues:        []KeyValue{{Key: "time", Value: "0s"}},
			Comment:          "",
		},
	},
